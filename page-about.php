...
<main>
	...
	<div class="page__content">
		<div class="page-about__vision">
			<h2 class="page__content-title">理念</h2>
			<p class="page-about__content-vision">
				職業技能教育の<br class="pc-none">普及と評価・承認を通して、<br>安心して働き続けられる<br class="pc-none">社会の実現を目指します。
			</p>
		</div>
		<!-- /.page-about__vision-->

		<div class="page-about__message">
			<h2 class="page__content-title">メッセージ</h2>
		...
		<div class="page-about__activity">
			<h2 class="page__content-title">活動内容</h2>
			<ul class="page-about__activity-list">
				<li class="page-about__list-item">職業技能の分析とそれに対応する専門教育の研究</li>
				<li class="page-about__list-item">職業技能専門教育の標準教育プログラムの開発と普及</li>
				<li class="page-about__list-item">職業技能専門教育の修了認定</li>
				<li class="page-about__list-item">機構が認定した修了者雇用企業の開拓</li>
				<li class="page-about__list-item">各教育機関の職業訓練支援</li>
			</ul>
		</div>
		<!-- /.page-about__activity-->

		<div class="page-about__overview">
			<h2 class="page__content-title">概要</h2>
			<table class="page-about__overview-table">
				<tr class="page-about__table-row">
					<th class="page-about__table-header">法人名</th>
					<td class="page-about__table-data">特定非営利活動法人<br class="pc-none"> 職業技能専門教育研究機構（PRO）</td>
				</tr>
				<tr class="page-about__table-row">
					<th class="page-about__table-header">英語表記</th>
					<td class="page-about__table-data">Professional training Research Organization of occupational skill</td>
				</tr>
				<tr class="page-about__table-row">
					<th class="page-about__table-header">所在地</th>
					<td class="page-about__table-data">〒160-0023 <br class="pc-none">東京都新宿区西新宿7-8-10 <br class="pc-none">オークラヤビル4F</td>
				</tr>
				<?php /*
					<tr class="page-about__table-row">
						<th class="page-about__table-header">TEL</th>
						<td class="page-about__table-data">03-6863-5641</td>
					</tr>
					*/ ?>
			</table>
			<?php /*
			<div class="page-about__overview-map">
